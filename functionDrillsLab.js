...
let capString = function(string){
  return string.toUpperCase()
}
console.log(capString(sampleString))
...
console.log(emailCheck('                jeff.derbesmail.com'))
...
let howManyFrogs = function(gold){
  let frogs = Math.floor(gold / 3)
  return `You were able to purchase ${frogs} frogs`
};

totalFrogs = howManyFrogs(11)
...
const ascending = function(arr){
  if (arr[0] < arr[arr.length -1]){
    ...
    return 'array is neither ascending or descending'
  }else {
    return 'descending'
  }
};
